var app = (function () {
        ...
        m.$on("click", e[4]),
        {
          c() {
            (t = w("header")),
              ...
              (l = x()),
              (u = w("h1")),
              (u.textContent = "Neverland Heardle"),
              (c = x()),
              (d = w("div")),
              Q(h.$$.fragment),
              (f = x()),
    ...
    function Nt(t) {
      ...
      return {
        c() {
          (n = w("div")),
            (n.innerHTML =
                '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a>, and <a href="https://heardle-kpop.glitch.me/" title="Heardle">K-Pop Heardle</a> but for (G)I-DLE songs.</p> \n\n<p class="mb-3">Each Neverland Heardle is randomly chosen from (G)I-DLE\'s discography. All copyright goes to CUBE Entertainment, U-CUBE, Republic Records, and Riot Games.</p> \n\n<p class="mb-3">Songs included are OT6, solo works, feature songs and OSTs. Thanks for playing!</p> \n\n\n\n<p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">Soundcloud</a>,\n    <a href="https://svelte.dev">Svelte</a>,\n    <a href="https://tailwindcss.com">Tailwind</a>,\n    <a href="https://fonts.google.com/noto/specimen/Noto+Serif+Display">Noto Serif Display</a>, <a href="https://fonts.google.com/noto/specimen/Noto+Sans">Noto Sans</a>,\n    <a href="https://iconsvg.xyz">IconSVG</a>, <a href="https://momentjs.com">momentjs</a>,\n    <a href="https://tarekraafat.github.io/autoComplete.js/#/">autocomplete.js</a>, and powered by <a href="https://glitch.com/">Glitch</a>.         <a href="https://omakase.studio" title="Studio Omakase">Served omakase / お任せ</a>.   (G)I-DLE version of Heardle made by <a href="https://twitter.com/cyphershuyoo">cyphershuyoo</a>.</p>'),
            M(n, "class", "text");
        },
        m(e, t) {
          g(e, n, t);
    ...
    function Gt(t) {
      ...
      return {
        c() {
            ...
            M(o, "class", "pb-6"),
            M(i, "class", "text-custom-mg text-xs h-6 justify-center relative"),
    ...
    function jt(e, t, n) {
      ...
      return (
        P(async function () {
          (async function () {
            const e = await fetch(
              "https://nevie-heardle.glitch.me/supporters.json"
            );
            return await e.json();
          })().then((e) => {
            n(0, (r = e.supporters));
        ...
        (u = new Bt({})),
        {
          c() {
            (n = w("p")),
              ...
              (s = w("p")),
              (s.innerHTML =
                '<p class="mb-3">If you\'ve enjoyed playing Neverland Heardle, then please consider supporting the <a href="https://ko-fi.com/heardle">real Heardle devs</a>.</p>'),
              (i = x()),
              (o = w("div")),
              Q(a.$$.fragment),
              (l = x()),
    ...
    const Vt = {
      ...
      Jt = [
        "You just got deported from NEVERLAND.", // FAILED
        "First try? LUV U! Soyeon would be proud :D", // First try
        "I MADE more like YOU MADE a mistake.",
        "HEAR ME out, you did alright",
        "Four tries? I'm glad you didn't QUIT",
        "Uh-Oh, just barely got it.",
        "Let me PUT IT STRAIGHT, it took you a bit", // Sixth try
      ];
    function Kt(t) {
      let n, r;
      return {
        ...
        (O = new Rt({})),
        {
          c() {
            ...
            (o = x()),
              ...
              (m = w("div")),
              (k = w("div")),
              (k.textContent = "Next (G)I-DLE song in:"),
              (b = x()),
              Q(S.$$.fragment),
              (D = x()),
              (T = w("div")),
    ...
    function an(e) {
      ...
      return {
        c() {
          (t = _("You got today's Neverland Heardle within the first ")),
            (n = _(s)),
            (r = _(" seconds."));
        },
        m(e, s) {
    ...
    function ln(e) {
      ...
      return {
        c() {
          (t = _("You got today's Neverland Heardle within ")),
            (n = _(o)),
            (r = _("\n                second")),
            (s = _(a)),
            (i = _("."));
    ...
    function un(t) {
      ...
      return {
        c() {
          n = _("You didn't get today's Neverland Heardle. Better luck tomorrow!");
        },
        m(e, t) {
          g(e, n, t);
        },
    ...
    function fn(e, t, n) {
      ...
      return (
        ...
        [
          ...
          c,
          () => {
            let e = "Neverland Heardle #" + (s.id + 1),
              t = "";
            a
    ...
    const Cn = ue([
        ...
        "(G)I-DLE - DUMDi DUMDi",
        "(G)I-DLE - Tung Tung - Empty",
        "(G)I-DLE, K/DA - THE BADDEST",
        "(G)I-DLE, K/DA - MORE",
        "(G)I-DLE - HWAA",
        ...
        "MIYEON, MINNIE, YUQI- I Don't Love You(널 사랑하지 않아)",
        "MIYEON - 'You Were My Breath' (너는 나의 숨이였다)",
        "MIYEON - My Destiny",
        "MIYEON - Someday",
        "MIYEON, Raiden - Side Effects",
        "MIYEON, DONGHAE - Blue Moon",
        "MIYEON, Kid Milli - Kitty",
        "MIYEON - How To Love",
        "MIYEON - Drive",
        "MIYEON - Softly",
        "MIYEON - TE AMO",
        ...
        "JEON SOYEON - Quit",
        "JEON SOYEON - Psycho",
        "JEON SOYEON - Is this bad b****** number?",
        "JEON SOYEON, Colde - New Vision",
        "JEON SOYEON - NANRINA",
        "JEON SOYEON - A Little Lovin",
        "JEON SOYEON - the loveless",
        "JEON SOYEON, True Damage - GIANTS",
        "JEON SOYEON - Fire",
        "JEON SOYEON, HYO - DESSERT",
        "JEON SOYEON, SEULGI, CHUNG HA, SinB - Wow Thing",
        "JEON SOYEON, KEY - I Wanna Be",
        "JEON SOYEON, LEE MINHYUK - Hang out",
        "JEON SOYEON, RAVI - ANI",
      ...
      On = {
        subscribe: ue(
          [
            {
              url: "https://soundcloud.com/gi-dle/my-bag",
            ...
            {
              url: "https://soundcloud.com/thaetamii/my-dearest-part-4-the-painted-on-the-moonlight",
            ...
            {
              url: "https://soundcloud.com/l2share148/kid-milli-dress-kitty-feat-miyeon-gi-dle",
              answer: "MIYEON, Kid Milli - Kitty",
            },
            {
              url: "https://soundcloud.com/gi-dle/dont-text-me",
            ...
            {
              url: "https://soundcloud.com/sophia-jesa/i-wanna-be-key-ft-soyeon",
              answer: "JEON SOYEON, KEY - I Wanna Be",
            },
            {
              url: "https://soundcloud.com/gi-dle/my-bag",
              answer: "(G)I-DLE - MY BAG",
            ...
            {
              url: "https://soundcloud.com/nurul-cahyani/minnie-miyeon-g-i-dle-we",
              answer: "MIYEON, MINNIE - We Already Fell In Love",
            },
            {
              url: "https://soundcloud.com/gi-dle/w6vlab1am6jm",
              answer: "(G)I-DLE - $$$",
            },
            {
              url: "https://soundcloud.com/valentinakpop/jeon-soyeon-jelly",
            ...
            {
              url: "https://soundcloud.com/pink-l-81096981/the-loveless-soyeon-of-gi-dle",
              answer: "JEON SOYEON - the loveless",
            },
            {
              url: "https://soundcloud.com/gi-dle/i-do",
              answer: "(G)I-DLE - I DO",
            },
            {
              url: "https://soundcloud.com/l2share145/donghae-blue-moon-feat-miyeon-gi-dle-of",
              answer: "MIYEON, DONGHAE - Blue Moon",
            },
            {
              url: "https://soundcloud.com/gi-dle/hann-alone",
              answer: "(G)I-DLE - HANN(Alone)",
            },
            {
              url: "https://soundcloud.com/miyeon-music/drive",
              answer: "MIYEON - Drive",
            },
            {
            ...
            {
              url: "https://soundcloud.com/gi-dle/whats-in-your-house",
              answer: "(G)I-DLE - What's in your house?",
            },
            {
            ...
            },
            {
              ...
              answer: "JEON SOYEON - A Little Lovin",
            },
            {
              url: "https://soundcloud.com/gi-dle/put-it-straight",
              answer: "(G)I-DLE - Put It Straight",
            },
            {
              url: "https://soundcloud.com/gi-dle/dumdi-dumdi",
              answer: "(G)I-DLE - DUMDi DUMDi",
            },
            {
              url: "https://soundcloud.com/miyeon-music/charging-feat-junny",
            ...
            {
              url: "https://soundcloud.com/gi-dle/oh-my-god",
            ...
            },
            {
              ...
              answer: "JEON SOYEON, RAVI - ANI",
            },
            {
              url: "https://soundcloud.com/gi-dle/villain-dies",
              answer: "(G)I-DLE - VILLAIN DIES",
            },
            {
              url: "https://soundcloud.com/erl8jj3ogszh/in-the-novel-g-i-dle-minnie",
              answer: "MINNIE - In The Novel",
            },
            {
              url: "https://soundcloud.com/gi-dle/moon",
              answer: "(G)I-DLE - MOON",
            },
            {
              url: "https://soundcloud.com/gi-dle/uh-oh",
              answer: "(G)I-DLE - Uh Oh",
            },
            {
              url: "https://soundcloud.com/user-585613382/feat-day-of-a-kid",
              answer: "JEON SOYEON, SUPERBEE - Day of a kid",
            },
            {
            ...
            {
              url: "https://soundcloud.com/jeonsoyeon-music/weather",
              answer: "JEON SOYEON - Weather",
            },
            {
              url: "https://soundcloud.com/sabina-magda/miyeon-g-i-dle-dreaming-about",
            ...
            {
              url: "https://soundcloud.com/nook-kanate/money-honey-f-hero-x-urboytj",
              answer: "MINNIE, F.HERO x URBOYTJ - MONEY HONEY",
            },
            {
            ...
            },
            {
              ...
              answer: "(G)I-DLE - Give Me Your",
            },
            {
              url: "https://soundcloud.com/yenxhr-davenport/jeon-soyeon-smile",
              answer: "JEON SOYEON, myunDo - Smile",
            },
            {
              url: "https://soundcloud.com/miyeon-music/rain",
              answer: "MIYEON - Rain",
            },
            {
              url: "https://soundcloud.com/gi-dle/lion",
              answer: "(G)I-DLE - LION",
            },
            {
              url: "https://soundcloud.com/jeonsoyeon-music/quit",
            ...
            {
              url: "https://soundcloud.com/gi-dle/tung-tung-empty",
              answer: "(G)I-DLE - Tung Tung - Empty",
            },
            {
              url: "https://soundcloud.com/arushi-barapatre/saying-hello-by-minnie",
              answer: "MINNIE - Saying Hello",
            },
            {
              url: "https://soundcloud.com/gi-dle/hwaa",
              answer: "(G)I-DLE - HWAA",
            },
            {
              url: "https://soundcloud.com/user-969302991/g-idle-put-it-straight?",
            ...
            {
              url: "https://soundcloud.com/dawnbringer-mauroogami/kda-more",
              answer: "(G)I-DLE, K/DA - MORE",
            },
            {
              url: "https://soundcloud.com/gi-dle/hann-alone-in-winter",
              answer: "(G)I-DLE - HANN(Alone in winter)",
            },
            {
              url: "https://soundcloud.com/miyeon-music/rose",
              answer: "MIYEON - Rose",
            },
            {
              url: "https://soundcloud.com/gi-dle/never-stop-me",
              answer: "(G)I-DLE - Never Stop Me",
            },
            {
              url: "https://soundcloud.com/valeandres012/hyo-dessert-feat-loopy-and",
              answer: "JEON SOYEON, HYO - DESSERT",
            },
            {
              url: "https://soundcloud.com/gi-dle/escape",
              answer: "(G)I-DLE - ESCAPE",
            },
            {
              url: "https://soundcloud.com/l2share89/wengie-empire-feat-minnie-of-gi-dle",
            ...
            {
              url: "https://soundcloud.com/ciphercrunch2120/mv-miyeon-gi-dle-how-to-love-with-neon-paprika-ost",
              answer: "MIYEON - How To Love",
            },
            {
              url: "https://soundcloud.com/l2share143/colde-jeon-soyeon-new-vision",
              answer: "JEON SOYEON - NANRINA",
            },
            {
              url: "https://soundcloud.com/gi-dle/lost",
              answer: "(G)I-DLE - LOST",
            },
            {
              url: "https://soundcloud.com/leagueoflegends/true-damage-giants-ft-becky-g-keke-palmer-soyeon-duckwrth-thutmose",
              answer: "JEON SOYEON, True Damage - GIANTS",
            },
            {
              url: "https://soundcloud.com/miyeon-music/softly",
              answer: "MIYEON - Softly",
            },
            {
              url: "https://soundcloud.com/nurul-ad/huta-lee-min-hyuk-hang-out",
              answer: "JEON SOYEON, LEE MINHYUK - Hang out",
            },
            {
              url: "https://soundcloud.com/l2share131/yuqi-bonnieclyde",
              answer: "YUQI - Bonnie & Clyde",
            },
            {
              url: "https://soundcloud.com/gi-dle/tomboy",
              answer: "(G)I-DLE - TOMBOY",
            },
            {
              url: "https://soundcloud.com/satgotnick/5gh",
              answer: "MIYEON, MINNIE, YUQI - I Don't Love You(널 사랑하지 않아)",
            },
            {
              url: "https://soundcloud.com/jeonsoyeon-music/is-this-bad-b-number-feat-bibi",
              answer: "JEON SOYEON - Is this bad b****** number?",
            },
            {
              url: "https://soundcloud.com/intansuryaism/getaway-minnie-my-dangerous-wife-ost-part-2",
              answer: "MINNIE - Getaway",
            },
            {
              url: "https://soundcloud.com/vitor-g-758911133/g-idle-relay",
              answer: "(G)I-DLE - Relay",
            },
            {
              url: "https://soundcloud.com/gi-dle/dahlia",
              answer: "(G)I-DLE - DAHLIA",
            },
            {
              url: "https://soundcloud.com/jeonsoyeon-music/idle-song",
              answer: "JEON SOYEON - Idle song",
            },
            {
              url: "https://soundcloud.com/gi-dle/love",
              answer: "(G)I-DLE - LOVE",
            },
            {
            ...
            {
              url: "https://soundcloud.com/leagueoflegends/kda-the-baddest",
              answer: "(G)I-DLE, K/DA - THE BADDEST",
            },
            {
              url: "https://soundcloud.com/ffuts-kk/miyeon-my-destiny-remake",
              answer: "MIYEON - My Destiny",
            ...
            {
              url: "https://soundcloud.com/gi-dle/reset",
              answer: "(G)I-DLE - Reset",
            },
            {
              url: "https://soundcloud.com/sophia-jesa/i-wanna-be-key-ft-soyeon",
              answer: "JEON SOYEON, KEY - I Wanna Be",
            ...
            {
              url: "https://soundcloud.com/gi-dle/blow-your-mind",
              answer: "(G)I-DLE - Blow Your Mind",
            },
            {
              url: "https://soundcloud.com/gi-dle/nxde",
              answer: "(G)I-DLE - Nxde",
            },
            {
              url: "https://soundcloud.com/gi-dle/queencard",
              answer: "(G)I-DLE - Queencard",
            },
            {
              url: "https://soundcloud.com/l2share143/colde-jeon-soyeon-new-vision",
              answer: "JEON SOYEON, Colde - New Vision",
            },
            {
              url: "https://soundcloud.com/yuqi-sc/giant",
              answer: "YUQI - Giant",
            },
            {
              url: "https://soundcloud.com/gi-dle/all-night",
              answer: "(G)I-DLE - All Night",
            },
            {
              url: "https://soundcloud.com/gi-dle/im-the-trend",
              answer: "(G)I-DLE - i'M THE TREND",
            },
            {
              url: "https://soundcloud.com/gi-dle/lucid",
              answer: "(G)I-DLE - Lucid",
            },
            {
              url: "https://soundcloud.com/moonbyulkiki6/anne-marie-minnie-gi-dle-expectations",
              answer: "MINNIE, ANNE MARIE - Expectations",
            },
            {
              url: "https://soundcloud.com/leagueoflegends/kda-popstars-ft-madison-beer-gi-dle-jaira-burns",
              answer: "(G)I-DLE, K/DA - POP/STARS",
            },
            {
              url: "https://soundcloud.com/l2share129/gidle-last-dance",
              answer: "(G)I-DLE - Last Dance",
            },
            {
              url: "https://soundcloud.com/moonbyulkiki19/miyeon-yuqi-how-to-twerk-prod",
            ...
            {
              url: "https://soundcloud.com/l2shareost18/gi-dle-help-me-her-private-life-ost-part-3",
              answer: "(G)I-DLE - Help Me",
            },
            {
              url: "https://soundcloud.com/jeonsoyeon-music/psycho",
              answer: "JEON SOYEON - Psycho",
            },
            {
              url: "https://soundcloud.com/gi-dle/for-you",
              answer: "(G)I-DLE - For You",
            },
            {
              url: "https://soundcloud.com/ciphercrunch2120/gi-dle-miyeon-raiden-side-effects",
              answer: "MIYEON, Raiden - Side Effects",
            },    
            {
      ...
      return {
        c() {
          (t = w("meta")),
            ...
            (C = x()),
            H && H.c(),
            (An.title = "Neverland Heardle - That (G)I-DLE song intros game"),
            M(t, "name", "description"),
            M(
              t,
              "content",
              "Guess the (G)I-D:E song from the intro in as few tries as possible"
            ),
    ...
    function jn(e, t, n) {
      ...
      let a = x("2022-04-03"),
        l = {
          url: s[x(Vt.startDate) % s.length].url,
          correctAnswer: s[x(Vt.startDate) % s.length].answer,
          id: x(Vt.startDate),
          guessList: [],
          hasFinished: !1,
          hasStarted: !1,
